...
//     // Fetch years for the course
//     const { data: yearData, isLoading: isYearLoading, error: yearError } = useGetYearToCourseQuery({ courseId });
...
//         }
//     };
//     // const yearId = selectedYear?._id;
    
//     const handleViewSubjects = (yearId: string) => {
//         // router.push(`/admin/subjectfetch/${yearId}?courseId=${courseId}`);
